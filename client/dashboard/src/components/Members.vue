...
export default {
  ...
  methods: {
    getMembers: function () {
      var self = this
      axios.get('http://ec2-13-59-91-91.us-east-2.compute.amazonaws.com:3000/api/members')
    ...
    postMember: function () {
      var self = this
      axios.post('http://ec2-13-59-91-91.us-east-2.compute.amazonaws.com:3000/api/members/signup', {
    ...
    signinMember: function () {
      var self = this
      axios.post(`http://ec2-13-59-91-91.us-east-2.compute.amazonaws.com:3000/api/members/signin`, {
